...
<title>DevToolBox - Authorization Required</title>
<style>
...
<body>
  ...
  <div class="card">
    ...
    <div class="title">Authorization Required</div>
    <div class="subtitle">This DevToolBox requires authorization to access.<br>Please get the access URL from the terminal.</div>
    ...
    <div class="hint">
      ...
      Start the application to get your access URL
    </div>
  </div>

  <div class="footer">DevToolBox &mdash; Local-First Developer Toolkit</div>
</body>
</html>'''


def get_lock_page_html():
    return LOCK_PAGE_HTML
